...
execute as @p[tag=conversacionPetra,scores={timerIntroPetra=20000}] run tag @p remove conversacionPetra
...
execute as @p[tag=prePetra,scores={timerPrePetra=20000}] run tag @p remove prePetra
...
execute as @p[tag=postPetra,scores={timerPostPetra=20000}] run tag @p remove postPetra
