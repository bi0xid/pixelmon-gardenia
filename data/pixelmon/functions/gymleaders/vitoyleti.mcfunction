...
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=20}] run tellraw @p {"text":"<Vito> ...así que toma esto como reconocimiento!"}
...
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=100}] run tellraw @p {"text":"<Vito> La Medalla Mente permite a los Pokémon usar la MO Buceo!"}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=120}] run tellraw @p {"text":"<Leti> Y toma esto también!"}
...
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=240}] run tellraw @p {"text":"<Leti> Calma Mental..."}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=260}] run tellraw @p {"text":"<Vito> ...proviene de relajar tu mente y concentrarte."}

execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=320}] run tellraw @p {"text":"<Leti> El Ataque Especial de los Pokémon y..."}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=320}] run tellraw @p {"text":"<Vito> ...la Defensa Especial de los Pokémon..."}

execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=380}] run tellraw @p {"text":"<Leti> ...se verá aumentada por este movimiento!"}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=400}] run tellraw @p {"text":"<Vito> ¡Es un movimiento perfecto para los Pokémon de tipo Psíquico!"}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=420}] run tellraw @p {"text":"<Vito> Parece que el vínculo entre tú y tus Pokémon es mucho más fuerte que el que compartimos como gemelos..."}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=440}] run tellraw @p {"text":"<Vito> ¡Pero seguirás formando aún más vínculos a partir de ahora! ¡Ese es el futuro que veo para ti!"}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=460}] run tellraw @p {"text":"<Leti> Puede haber una dura prueba por delante para ti y tus Pokémon..."}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=480}] run tellraw @p {"text":"<Leti> ¡Pero eso está bien! ¡Tú y tus Pokémon no estáis solos!"}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=500}] run tellraw @p {"text":"<Leti> ¡Os tenéis los unos a los otros!"}
execute as @p[tag=postVitoLeti,scores={timerPostVitoLeti=520}] run tellraw @p {"text":"<Leti> ¡Por eso queremos que enfrentes cualquier problema que te venga con valentía y con la cabeza alta!"}
